...
class User(Base):
    ...
    user_products: Mapped[list["Products"]] = relationship(
        back_populates="products_user",
        cascade="all, delete-orphan"
    )
    user_purchases: Mapped[list["Purchases"]] = relationship(
        back_populates="purchases_user",
        cascade="all, delete-orphan"
    )
