...
@auth()
# ...
async def cmt_products_create(request):
    # ..
    id = request.path_params["id"]
    # ..
    new = Comment()
...
@auth()
# ...
async def cmt_purchases_create(request):
    # ..
    id = request.path_params["id"]
    # ..
    new = Comment()
...
@auth()
# ...
async def cmt_products_update(request):
    # ..
    id = request.path_params["id"]
    async with async_session() as session:
        i = await for_id(session, Comment, id)
...
@auth()
# ...
async def cmt_purchases_update(request):
    # ..
    id = request.path_params["id"]
    async with async_session() as session:
        i = await for_id(session, Comment, id)
